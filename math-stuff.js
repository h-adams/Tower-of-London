    ...
    return function(e) {
        ...
        t.create = function(e) {
            function t(e) {
                ...
                var i, o = r.indexOf(e);
                return -1 === o ? (i = e.math === !0 ? e.factory(c.type, f, t, c.typed, c) : e.factory(c.type, f, t, c.typed), r.push(e), u.push(i)) : i = u[o], i
            }
        ...
        var n, i, o;
        ! function(r, a) {
            i = [], n = a, o = "function" == typeof n ? n.apply(t, i) : n, !(void 0 !== o && (e.exports = o))
        }(this, function() {
            function e() {
                function t(e) {
                ...
                function n(e, t, r, n, i) {
                    ...
                    o = s ? t > r && !c ? "Unexpected type of argument in function " + u + " (expected: " + s.join(" or ") + ", actual: " + a + ", index: " + r + ")" : "Too few arguments in function " + u + " (expected: " + s.join(" or ") + ", index: " + r + ")" : "Too many arguments in function " + u + " (expected: " + r + ", actual: " + t + ")";
                ...
                function f(e, t) {
                    var r, n, i, a = t.length,
                        u = [];
                    for (r = 0; r < e.length; r++) n = e[r], n.params.length !== a || i || (i = n), void 0 != n.params[a] && u.push(n);
                    u.sort(function(e, t) {
                ...
                function p(e, t) {
                    ...
                    var a = f(o, []),
                        ...
                        p = e || "",
                        m = l(h(o));
                    s.push("function " + p + "(" + m.join(", ") + ") {"), s.push('  "use strict";'), s.push("  var name = '" + p + "';"), s.push(a.toCode(r, "  ")), s.push("}");
                ...
                i.prototype.add = function(e, t) {
                    ...
                    for (var n in r)
                        if (r.hasOwnProperty(n))
                            for (var i = r[n], o = 0; o < i.length; o++) e.push("var " + n + o + " = " + t + "['" + n + "'][" + o + "];");
                    return e.join("\n")
                    ...
                    function e(r, n) {
                        if (n.length < r.params.length) {
                            ...
                            if (c.varArgs) {
                                ...
                                for (i = 0; i < N.conversions.length; i++) u = N.conversions[i], !d(c.types, u.from) && d(c.types, u.to) && (s = new o(u.from), s.conversions[0] = u, e(r, n.concat(s)))
                            }
                    ...
                    var r, n = e.params.length,
                        i = 0,
                        a = 0;
                    for (r = 0; n > r; r++) e.params[r].hasConversions() && i++, t.params[r].hasConversions() && a++;
                    if (i > a) return 1;
                    if (a > i) return -1;
                    ...
                    for (var r = [], n = new Array(this.params.length), i = 0; i < this.params.length; i++) {
                        var o = this.params[i],
                            a = o.conversions[0];
                        o.varArgs ? n[i] = "varArgs" : a ? n[i] = e.add(a.convert, "convert") + "(arg" + i + ")" : n[i] = "arg" + i
                    }
                    ...
                    if (this.param) {
                        ...
                        if (this.param.varArgs)
                            if (this.param.anyType) i.push(r + "if (arguments.length > " + o + ") {"), i.push(r + "  var varArgs = [];"), i.push(r + "  for (var i = " + o + "; i < arguments.length; i++) {"), i.push(r + "    varArgs.push(arguments[i]);"), i.push(r + "  }"), i.push(this.signature.toCode(e, r + "  ")), i.push(r + "}");
                            else {
                                for (var u = function(r, n) {
                                        for (var i = [], o = 0; o < r.length; o++) i[o] = e.add(t(r[o]), "test") + "(" + n + ")";
                                        return i.join(" || ")
                                    }.bind(this), c = this.param.types, f = [], l = 0; l < c.length; l++) void 0 === this.param.conversions[l] && f.push(c[l]);
                                i.push(r + "if (" + u(c, "arg" + o) + ") { " + s), i.push(r + "  var varArgs = [arg" + o + "];"), i.push(r + "  for (var i = " + (o + 1) + "; i < arguments.length; i++) {"), i.push(r + "    if (" + u(f, "arguments[i]") + ") {"), i.push(r + "      varArgs.push(arguments[i]);");
                            ...
                            i.push(r + "if (" + h + "(arg" + o + ")) { " + s), i.push(this._innerCode(e, r + "  ", n)), i.push(r + "}")
                        }
        ...
        function r(e) {
            ...
            var r = t[1],
                ...
                i = parseFloat(t[4] || "0"),
                o = n.indexOf(".");
            i += -1 !== o ? o - 1 : n.length - 1, this.sign = r, this.coefficients = n.replace(".", "").replace(/^0*/, function(e) {
                return i -= e.length, ""
        ...
        r.prototype.toEngineering = function(e) {
            ...
            var f = i.slice(u).join(""),
                l = f.match(/[1-9]/) ? "." + f : "";
            return c = i.slice(0, u).join("") + l, c += "e" + (r >= 0 ? "+" : "") + o.toString(), t.sign + c
        }, r.prototype.toFixed = function(e) {
            var t = this.roundDigits(this.exponent + 1 + (e || 0)),
                r = t.coefficients,
                i = t.exponent + 1,
                o = i + (e || 0);
            return r.length < o && (r = r.concat(n(o - r.length))), 0 > i && (r = n(-i + 1).concat(r), i = 1), e && r.splice(i, 0, 0 === i ? "0." : "."), this.sign + r.join("")
            ...
            var o = r.shift();
            return this.sign + o + (r.length > 0 ? "." + r.join("") : "") + "e" + (i >= 0 ? "+" : "") + i
        ...
        r.prototype = {
            ...
            off: function(e, t) {
                var r = this.e || (this.e = {}),
                    ...
                    i = [];
                if (n && t)
                    for (var o = 0, a = n.length; a > o; o++) n[o].fn !== t && n[o].fn._ !== t && i.push(n[o]);
        ...
        function a(e, t, r) {
            if (void 0 !== e[t] && !i(r, e[t])) {
                var n = o(r, e[t]); - 1 !== n ? (console.warn('Warning: Wrong casing for configuration option "' + t + '", should be "' + r[n] + '" instead of "' + e[t] + '".'), e[t] = r[n]) : console.warn('Warning: Unknown value "' + e[t] + '" for configuration option "' + t + '". Available options: ' + r.map(JSON.stringify).join(", ") + ".")
            }
        }
        var s = r(3);
        ...
        ! function(i) {
            ...
            function o(e) {
                var t, r, n, i = e.length - 1,
                    ...
                    a = e[0];
                if (i > 0) {
                    for (o += a, t = 1; i > t; t++) n = e[t] + "", r = Pe - n.length, r && (o += g(r)), o += n;
            ...
            function s(e, t, r, n) {
                ...
                return --t < 0 ? (t += Pe, i = 0) : (i = Math.ceil((t + 1) / Pe), t %= Pe), o = Ce(10, Pe - t), s = e[i] % o | 0, null == n ? 3 > t ? (0 == t ? s = s / 100 | 0 : 1 == t && (s = s / 10 | 0), a = 4 > r && 99999 == s || r > 3 && 49999 == s || 5e4 == s || 0 == s) : a = (4 > r && s + 1 == o || r > 3 && s + 1 == o / 2) && (e[i + 1] / o / 100 | 0) == Ce(10, t - 2) - 1 || (s == o / 2 || 0 == s) && 0 == (e[i + 1] / o / 100 | 0) : 4 > t ? (0 == t ? s = s / 1e3 | 0 : 1 == t ? s = s / 100 | 0 : 2 == t && (s = s / 10 | 0), a = (n || 4 > r) && 9999 == s || !n && r > 3 && 4999 == s) : a = ((n || 4 > r) && s + 1 == o || !n && r > 3 && s + 1 == o / 2) && (e[i + 1] / o / 1e3 | 0) == Ce(10, t - 3) - 1, a
            }

            function u(e, t, r) {
                for (var n, i, o = [0], a = 0, s = e.length; s > a;) {
                    for (i = o.length; i--;) o[i] *= t;
                    for (o[0] += xe.indexOf(e.charAt(a++)), n = 0; n < o.length; n++) o[n] > r - 1 && (void 0 === o[n + 1] && (o[n + 1] = 0), o[n + 1] += o[n] / r | 0, o[n] %= r)
                }
                return o.reverse()
            }
            ...
            function c(e, t) {
                ...
                32 > i ? (r = Math.ceil(i / 3), n = Math.pow(4, -r).toString()) : (r = 16, n = "2.3283064365386962890625e-10"), e.precision += r, t = O(e, 1, t.times(n), new e(1));
                for (var o = r; o--;) {
                    var a = t.times(t);
            ...
            function f(e, t, r, n) {
                var i, o, a, s, u, c, f, l, p, h = e.constructor;
                e: if (null != t) {
                    if (l = e.d, !l) return e;
                    for (i = 1, s = l[0]; s >= 10; s /= 10) i++;
                    if (o = t - i, 0 > o) o += Pe, a = t, f = l[p = 0], u = f / Ce(10, i - a - 1) % 10 | 0;
                    ...
                    if (n = n || 0 > t || void 0 !== l[p + 1] || (0 > a ? f : f % Ce(10, i - a - 1)), c = 4 > r ? (u || n) && (0 == r || r == (e.s < 0 ? 3 : 2)) : u > 5 || 5 == u && (4 == r || n || 6 == r && (o > 0 ? a > 0 ? f / Ce(10, i - a) : 0 : l[p - 1]) % 10 & 1 || r == (e.s < 0 ? 8 : 7)), 1 > t || !l[0]) return l.length = 0, c ? (t -= e.e + 1, l[0] = Ce(10, (Pe - t % Pe) % Pe), e.e = -t || 0) : l[0] = e.e = 0, e;
                    if (0 == o ? (l.length = p, s = 1, p--) : (l.length = p + 1, s = Ce(10, Pe - o), l[p] = a > 0 ? (f / Ce(10, i - a) % Ce(10, a) | 0) * s : 0), c)
                        for (;;) {
                            if (0 == p) {
            ...
            function l(e, t, r) {
                ...
                var n, i = e.e,
                    a = o(e.d),
                    s = a.length;
                return t ? (r && (n = r - s) > 0 ? a = a.charAt(0) + "." + a.slice(1) + g(n) : s > 1 && (a = a.charAt(0) + "." + a.slice(1)), a = a + (e.e < 0 ? "e" : "e+") + e.e) : 0 > i ? (a = "0." + g(-i - 1) + a, r && (n = r - s) > 0 && (a += g(n))) : i >= s ? (a += g(i + 1 - s), r && (n = r - i - 1) > 0 && (a = a + "." + g(n))) : ((n = i + 1) < s && (a = a.slice(0, n) + "." + a.slice(n)), r && (n = r - s) > 0 && (i + 1 === s && (a += "."), a += g(n))), a
            }
            ...
            function b(e, t) {
                ...
                for (n = Math.log(Ce(2, m)) / Math.LN10 * 2 + 5 | 0, l += n, r = a = u = new d(1), d.precision = l;;) {
                    if (a = f(a.times(e), l, 1), r = r.times(++h), c = u.plus(je(a, r, l, 1)), o(c.d).slice(0, l) === o(u.d).slice(0, l)) {
            ...
            function w(e, t) {
                ...
                if (null == t ? (Me = !1, m = M) : m = t, N.precision = m += y, r = o(b), n = r.charAt(0), !(Math.abs(a = x.e) < 15e14)) return p = h(N, m + 2, M).times(a + ""), x = w(new N(n + "." + r.slice(1)), m - y).plus(p), N.precision = M, null == t ? f(x, M, E, Me = !0) : x;
                for (; 7 > n && 1 != n || 1 == n && r.charAt(1) > 3;) x = x.times(e), r = o(x.d), n = r.charAt(0), v++;
                for (a = x.e, n > 1 ? (x = new N("0." + r), a++) : x = new N(n + "." + r.slice(1)), d = x, l = u = x = je(x.minus(1), x.plus(1), m, 1), g = f(x.times(x), m, 1), i = 3;;) {
                    if (u = f(u.times(g), m, 1), p = l.plus(je(u, new N(i), m, 1)), o(p.d).slice(0, m) === o(l.d).slice(0, m)) {
                        if (l = l.times(2), 0 !== a && (l = l.plus(h(N, m + 2, M).times(a + ""))), l = je(l, new N(v), m, 1), null != t) return N.precision = M, l;
            ...
            function E(e, t) {
                ...
                if (t = t.slice(n, i)) {
                    if (i -= n, e.e = r = r - n - 1, e.d = [], n = (r + 1) % Pe, 0 > r && (n += Pe), i > n) {
                        for (n && e.d.push(+t.slice(0, n)), i -= Pe; i > n;) e.d.push(+t.slice(n, n += Pe));
            ...
            function M(e, t) {
                ...
                for (o = t.search(/p/i), o > 0 ? (c = +t.slice(o + 1), t = t.substring(2, o)) : t = t.slice(2), o = t.indexOf("."), a = o >= 0, n = e.constructor, a && (t = t.replace(".", ""), s = t.length, o = s - o, i = v(n, new n(r), o, 2 * o)), f = u(t, r, Ie), l = f.length - 1, o = l; 0 === f[o]; --o) f.pop();
                return 0 > o ? new n(0 * e.s) : (e.e = p(f, l), e.d = f, Me = !1, a && (e = je(e, i, 4 * s)), c && (e = e.times(Math.abs(c) < 54 ? Math.pow(2, c) : Ne.pow(2, c))), Me = !0, e)
            }
            ...
            function O(e, t, r, n, i) {
                ...
                for (Me = !1, u = r.times(r), s = new e(n);;) {
                    if (a = je(s.times(u), new e(t++ * t++), f, 1), s = i ? n.plus(a) : n.minus(a), n = je(a.times(u), new e(t++ * t++), f, 1), a = s.plus(n), void 0 !== a.d[l]) {
            ...
            function _(e, t) {
                ...
                if (r = t.divToInt(i), r.isZero()) ge = n ? 3 : 2;
                    ...
                    if (t = t.minus(r.times(i)), t.lte(o)) return ge = y(r) ? n ? 2 : 3 : n ? 4 : 1, t;
                    ge = y(r) ? n ? 1 : 4 : n ? 3 : 2
                }
            ...
            function T(e, t, r, n) {
                var i, o, s, c, f, p, h, m, d, g = e.constructor,
                    v = void 0 !== r;
                if (v ? (a(r, 1, ye), void 0 === n ? n = g.rounding : a(n, 0, 8)) : (r = g.precision, n = g.rounding), e.isFinite()) {
                    for (h = l(e), s = h.indexOf("."), v ? (i = 2, 16 == t ? r = 4 * r - 3 : 8 == t && (r = 3 * r - 2)) : i = t, s >= 0 && (h = h.replace(".", ""), d = new g(1), d.e = h.length - s, d.d = u(l(d), 10, i), d.e = d.d.length), m = u(h, 10, i), o = f = m.length; 0 == m[--f];) m.pop();
                    if (m[0]) {
                        if (0 > s ? o-- : (e = new g(e), e.d = m, e.e = o, e = je(e, d, r, n, 0, i), m = e.d, o = e.e, p = de), s = m[r], c = i / 2, p = p || void 0 !== m[r + 1], p = 4 > n ? (void 0 !== s || p) && (0 === n || n === (e.s < 0 ? 3 : 2)) : s > c || s === c && (4 === n || p || 6 === n && 1 & m[r - 1] || n === (e.s < 0 ? 8 : 7)), m.length = r, p)
            ...
            function G(e) {
                function t(e) {
                    ...
                    if (i = typeof e, "number" === i) {
                        ...
                        return 0 * e !== 0 ? (e || (o.s = NaN), o.e = NaN, void(o.d = null)) : E(o, e.toString())
                    }
                    if ("string" !== i) throw Error(Oe + e);
                    return 45 === e.charCodeAt(0) ? (e = e.slice(1), o.s = -1) : o.s = 1, ke.test(e) ? E(o, e) : M(o, e)
                }
                var r, n, i;
            ...
            function oe(e) {
                var t, r, n, i, o = 0,
                    s = new this(1),
                    u = [];
                if (void 0 === e ? e = this.precision : a(e, 1, ye), n = Math.ceil(e / Pe), this.crypto === !1)
                    for (; n > o;) u[o++] = 1e7 * Math.random() | 0;
                else if (Ee && Ee.getRandomValues)
                    for (t = Ee.getRandomValues(new Uint32Array(n)); n > o;) i = t[o], i >= 429e7 ? t[o] = Ee.getRandomValues(new Uint32Array(1))[0] : u[o++] = i % 1e7;
                else if (Ee && Ee.randomBytes) {
                    for (t = Ee.randomBytes(n *= 4); n > o;) i = t[o] + (t[o + 1] << 8) + (t[o + 2] << 16) + ((127 & t[o + 3]) << 24), i >= 214e7 ? Ee.randomBytes(4).copy(t, o) : (u.push(i % 1e7), o += 4);
                    o = n / 4
                } else {
                    if (this.crypto) throw Error(Ae + "crypto unavailable");
                    for (; n > o;) u[o++] = 1e7 * Math.random() | 0
                }
                for (n = u[--o], e %= Pe, n && e && (i = Ce(10, Pe - e), u[o] = (n / i | 0) * i); 0 === u[o]; o--) u.pop();
                if (0 > o) r = 0, u = [0];
                else {
            ...
            Le.absoluteValue = Le.abs = function() {
                ...
                var t, r, n, i, o = this,
                    ...
                    u = o.s,
                    c = e.s;
                if (!a || !s) return u && c ? u !== c ? u : a === s ? 0 : !a ^ 0 > u ? 1 : -1 : NaN;
                ...
                var e, t, r = this,
                    n = r.constructor;
                return r.d ? r.d[0] ? (e = n.precision, t = n.rounding, n.precision = e + Math.max(r.e, r.sd()) + Pe, n.rounding = 1, r = c(n, _(n, r)), n.precision = e, n.rounding = t, f(2 == ge || 3 == ge ? r.neg() : r, e, t, !0)) : new n(1) : new n(NaN)
            }, Le.cubeRoot = Le.cbrt = function() {
                var e, t, r, n, i, a, s, u, c, l, p = this,
                    h = p.constructor;
                if (!p.isFinite() || p.isZero()) return new h(p);
                for (Me = !1, a = p.s * Math.pow(p.s * p, 1 / 3), a && Math.abs(a) != 1 / 0 ? n = new h(a.toString()) : (r = o(p.d), e = p.e, (a = (e - r.length + 1) % 3) && (r += 1 == a || -2 == a ? "0" : "00"), a = Math.pow(r, 1 / 3), e = Te((e + 1) / 3) - (e % 3 == (0 > e ? -1 : 2)), a == 1 / 0 ? r = "5e" + e : (r = a.toExponential(), r = r.slice(0, r.indexOf("e") + 1) + e), n = new h(r), n.s = p.s), s = (e = h.precision) + 3;;)
                    if (u = n, c = u.times(u).times(u), l = c.plus(p), n = je(l.plus(p).times(u), l.plus(c), s + 2, 1), o(u.d).slice(0, s) === (r = o(n.d)).slice(0, s)) {
                ...
                r = a.precision, n = a.rounding, a.precision = r + Math.max(o.e, o.sd()) + 4, a.rounding = 1, i = o.d.length, 32 > i ? (e = Math.ceil(i / 3), t = Math.pow(4, -e).toString()) : (e = 16, t = "2.3283064365386962890625e-10"), o = O(a, 1, o.times(t), new a(1), !0);
                for (var u, c = e, l = new a(8); c--;) u = o.times(o), o = s.minus(u.times(l.minus(u.times(l))));
                return f(o, a.precision = r, a.rounding = n, !0)
            }, Le.hyperbolicSine = Le.sinh = function() {
                var e, t, r, n, i = this,
                    o = i.constructor;
                if (!i.isFinite() || i.isZero()) return new o(i);
                if (t = o.precision, r = o.rounding, o.precision = t + Math.max(i.e, i.sd()) + 4, o.rounding = 1, n = i.d.length, 3 > n) i = O(o, 2, i, i, !0);
                else {
                    e = 1.4 * Math.sqrt(n), e = e > 16 ? 16 : 0 | e, i = i.times(Math.pow(5, -e)), i = O(o, 2, i, i, !0);
                ...
                var e, t = this,
                    ...
                    i = r.precision,
                    o = r.rounding;
                return -1 !== n ? 0 === n ? t.isNeg() ? m(r, i, o) : new r(0) : new r(NaN) : t.isZero() ? m(r, i + 4, o).times(.5) : (r.precision = i + 6, r.rounding = 1, t = t.asin(), e = m(r, i + 4, o).times(.5), r.precision = i, r.rounding = o, e.minus(t))
                ...
                var e, t, r, n, i = this,
                    o = i.constructor;
                return i.isFinite() ? i.e >= 0 ? new o(i.abs().eq(1) ? i.s / 0 : i.isZero() ? i : NaN) : (e = o.precision, t = o.rounding, n = i.sd(), Math.max(n, e) < 2 * -i.e - 1 ? f(new o(i), e, t, !0) : (o.precision = r = n - i.e, i = je(i.plus(1), new o(1).minus(i), r + e, 1), o.precision = e + 4, o.rounding = 1, i = i.ln(), o.precision = e, o.rounding = t, i.times(.5))) : new o(NaN)
            }, Le.inverseSine = Le.asin = function() {
                var e, t, r, n, i = this,
                    o = i.constructor;
                return i.isZero() ? new o(i) : (t = i.abs().cmp(1), r = o.precision, n = o.rounding, -1 !== t ? 0 === t ? (e = m(o, r + 4, n).times(.5), e.s = i.s, e) : new o(NaN) : (o.precision = r + 6, o.rounding = 1, i = i.div(new o(1).minus(i.times(i)).sqrt().plus(1)).atan(), o.precision = r, o.rounding = n, i.times(2)))
                ...
                if (c.isFinite()) {
                    ...
                    if (c.abs().eq(1) && qe >= p + 4) return a = m(l, p + 4, h).times(.25), a.s = c.s, a
                } else {
                    if (!c.s) return new l(NaN);
                    if (qe >= p + 4) return a = m(l, p + 4, h).times(.5), a.s = c.s, a
                }
                for (l.precision = s = p + 10, l.rounding = 1, r = Math.min(28, s / Pe + 2 | 0), e = r; e; --e) c = c.div(c.times(c).plus(1).sqrt().plus(1));
                for (Me = !1, t = Math.ceil(s / Pe), n = 1, u = c.times(c), a = new l(c), i = c; - 1 !== e;)
                    if (i = i.times(u), o = a.minus(i.div(n += 2)), i = i.times(u), a = o.plus(i.div(n += 2)), void 0 !== a.d[t])
                        for (e = t; a.d[e] === o.d[e] && e--;);
                return r && (a = a.times(2 << r - 1)), Me = !0, f(a, l.precision = p, l.rounding = h, !0)
                ...
                if (t)
                    ...
                    do
                        if (c += 10, u = w(p, c), n = t ? h(m, c + 10) : w(e, c), l = je(u, n, c, 1), !a) {
                            +o(l.d).slice(i + 1, i + 15) + 1 == 1e14 && (l = f(l, d + 1, 0));
                            break
                        } while (s(l.d, i += 10, g));
                return Me = !0, f(l, d, g)
            }, Le.minus = Le.sub = function(e) {
                var t, r, n, i, o, a, s, u, c, l, h, m, d = this,
                    g = d.constructor;
                ...
                if (r = Te(e.e / Pe), l = Te(d.e / Pe), c = c.slice(), o = l - r) {
                    for (h = 0 > o, h ? (t = c, o = -o, a = m.length) : (t = m, r = l, a = c.length), n = Math.max(Math.ceil(s / Pe), a) + 2, o > n && (o = n, t.length = 1), t.reverse(), n = o; n--;) t.push(0);
                    t.reverse()
                } else {
                ...
                for (h && (t = c, c = m, m = t, e.s = -e.s), a = c.length, n = m.length - a; n > 0; --n) c[a++] = 0;
                for (n = m.length; n > o;) {
                    if (c[--n] < m[n]) {
                ...
                var t, r, n, i, o, a, s, u, c, l, h = this,
                    m = h.constructor;
                ...
                if (o = Te(h.e / Pe), n = Te(e.e / Pe), c = c.slice(), i = o - n) {
                    for (0 > i ? (r = c, i = -i, a = l.length) : (r = l, n = o, a = c.length), o = Math.ceil(s / Pe), a = o > a ? o + 1 : a + 1, i > a && (i = a, r.length = 1), r.reverse(); i--;) r.push(0);
                    r.reverse()
                }
                for (a = c.length, i = l.length, 0 > a - i && (i = a, r = l, l = c, c = r), t = 0; i;) t = (c[--i] = c[i] + l[i] + t) / Ie | 0, c[i] %= Ie;
                ...
                var e, t, r = this,
                    n = r.constructor;
                return r.isFinite() ? r.isZero() ? new n(r) : (e = n.precision, t = n.rounding, n.precision = e + Math.max(r.e, r.sd()) + Pe, n.rounding = 1, r = A(n, _(n, r)), n.precision = e, n.rounding = t, f(ge > 2 ? r.neg() : r, e, t, !0)) : new n(NaN)
                ...
                for (Me = !1, l = Math.sqrt(+s), 0 == l || l == 1 / 0 ? (t = o(u), (t.length + c) % 2 == 0 && (t += "0"), l = Math.sqrt(t), c = Te((c + 1) / 2) - (0 > c || c % 2), l == 1 / 0 ? t = "1e" + c : (t = l.toExponential(), t = t.slice(0, t.indexOf("e") + 1) + c), n = new p(t)) : n = new p(l.toString()), r = (c = p.precision) + 3;;)
                    if (a = n, n = a.plus(je(s, a, r + 2, 1)).times(.5), o(a.d).slice(0, r) === (t = o(n.d)).slice(0, r)) {
                ...
                var t, r, n, i, o, a, s, u, c, l = this,
                    h = l.constructor,
                    m = l.d,
                    d = (e = new h(e)).d;
                if (e.s *= l.s, !(m && m[0] && d && d[0])) return new h(!e.s || m && !m[0] && !d || d && !d[0] && !m ? NaN : m && d ? 0 * e.s : e.s / 0);
                for (r = Te(l.e / Pe) + Te(e.e / Pe), u = m.length, c = d.length, c > u && (o = m, m = d, d = o, a = u, u = c, c = a), o = [], a = u + c, n = a; n--;) o.push(0);
                for (n = c; --n >= 0;) {
                    for (t = 0, i = u + n; i > n;) s = o[i] + d[n] * m[i - n - 1] + t, o[i--] = s % Ie | 0, t = s / Ie | 0;
                    o[i] = (o[i] + t) % Ie | 0
                }
                for (; !o[--a];) o.pop();
                ...
                var r = this,
                    n = r.constructor;
                return r = new n(r), void 0 === e ? r : (a(e, 0, ye), void 0 === t ? t = n.rounding : a(t, 0, 8), f(r, e + r.e + 1, t))
            }, Le.toExponential = function(e, t) {
                var r, n = this,
                    i = n.constructor;
                return void 0 === e ? r = l(n, !0) : (a(e, 0, ye), void 0 === t ? t = i.rounding : a(t, 0, 8), n = f(new i(n), e + 1, t), r = l(n, !0, e + 1)), n.isNeg() && !n.isZero() ? "-" + r : r
            }, Le.toFixed = function(e, t) {
                var r, n, i = this,
                    o = i.constructor;
                return void 0 === e ? r = l(i) : (a(e, 0, ye), void 0 === t ? t = o.rounding : a(t, 0, 8), n = f(new o(i), e + i.e + 1, t), r = l(n, !1, e + n.e + 1)), i.isNeg() && !i.isZero() ? "-" + r : r
            }, Le.toFraction = function(e) {
                var t, r, n, i, a, s, u, c, f, l, p, h, m = this,
                    g = m.d,
                    v = m.constructor;
                if (!g) return new v(m);
                if (f = r = new v(1), n = c = new v(0), t = new v(n), a = t.e = d(g) - m.e - 1, s = a % Pe, t.d[0] = Ce(10, 0 > s ? Pe + s : s), null == e) e = a > 0 ? t : f;
                else {
                    if (u = new v(e), !u.isInt() || u.lt(f)) throw Error(Oe + u);
                    e = u.gt(t) ? a > 0 ? t : f : u
                }
                for (Me = !1, u = new v(o(g)), l = v.precision, v.precision = a = g.length * Pe * 2; p = je(u, t, 0, 1, 1), i = r.plus(p.times(n)), 1 != i.cmp(e);) r = n, n = i, i = f, f = c.plus(p.times(i)), c = i, i = t, t = u.minus(p.times(i)), u = i;
                return i = je(e.minus(r), n, 0, 1, 1), c = c.plus(i.times(f)), r = r.plus(i.times(n)), c.s = f.s = m.s, h = je(f, n, a, 1).minus(m).abs().cmp(je(c, r, a, 1).minus(m).abs()) < 1 ? [f, n] : [c, r], v.precision = l, Me = !0, h
            }, Le.toHexadecimal = Le.toHex = function(e, t) {
                return T(this, 16, e, t)
            }, Le.toJSON = function() {
                var e, t, r, n, i, a, s, c, f = this,
                    l = f.s < 0;
                if (!f.d) return xe.charAt(f.s ? l ? 82 : 83 : 84);
                if (t = f.e, 1 === f.d.length && 4 > t && t >= 0 && (a = f.d[0], 2857 > a)) return 41 > a ? xe.charAt(l ? a + 41 : a) : (a -= 41, l && (a += 2816), n = a / 88 | 0, xe.charAt(n) + xe.charAt(a - 88 * n));
                ...
                else if (7744 > t) n += 2, a = t / 88 | 0, s = xe.charAt(a) + xe.charAt(t - 88 * a);
                else
                ...
                if (t = Te(e.e / Pe), r = e.d.length - 1, c = t >= r, u = l.s, c) {
                    if ((r = 0 > h ? -h : h) <= Re) return i = v(p, l, r, n), e.s < 0 ? new p(1).div(i) : f(i, n, a)
                } else if (0 > u) return new p(NaN);
                return u = 0 > u && 1 & e.d[Math.max(t, r)] ? -1 : 1, r = Ce(+l, h), t = 0 != r && isFinite(r) ? new p(r + "").e : Te(h * (Math.log("0." + o(l.d)) / Math.LN10 + l.e + 1)), t > p.maxE + 1 || t < p.minE - 1 ? new p(t > 0 ? u / 0 : 0) : (Me = !1, p.rounding = l.s = 1, r = Math.min(12, (t + "").length), i = b(e.times(w(l, n + r)), n), i = f(i, n + 5, 1), s(i.d, n, a) && (t = n + 10, i = f(b(e.times(w(l, t + r)), t), t + 5, 1), +o(i.d).slice(n + 1, n + 15) + 1 == 1e14 && (i = f(i, n + 1, 0))), i.s = u, Me = !0, p.rounding = a, f(i, n, a))
            }, Le.toPrecision = function(e, t) {
                var r, n = this,
                    i = n.constructor;
                return void 0 === e ? r = l(n, n.e <= i.toExpNeg || n.e >= i.toExpPos) : (a(e, 1, ye), void 0 === t ? t = i.rounding : a(t, 0, 8), n = f(new i(n), e, t), r = l(n, e <= n.e || n.e <= i.toExpNeg, e)), n.isNeg() && !n.isZero() ? "-" + r : r
            }, Le.toSignificantDigits = Le.toSD = function(e, t) {
                var r = this,
                    n = r.constructor;
                return void 0 === e ? (e = n.precision, t = n.rounding) : (a(e, 1, ye), void 0 === t ? t = n.rounding : a(t, 0, 8)), f(new n(r), e, t)
            ...
            var je = function() {
                ...
                return function(n, i, o, a, s, u) {
                    var c, l, p, h, m, d, g, v, y, x, b, w, N, E, M, A, O, _, T, C, S = n.constructor,
                        z = n.s == i.s ? 1 : -1,
                        B = n.d,
                        k = i.d;
                    if (!(B && B[0] && k && k[0])) return new S(n.s && i.s && (B ? !k || B[0] != k[0] : k) ? B && 0 == B[0] || !k ? 0 * z : z / 0 : NaN);
                    for (u ? (m = 1, l = n.e - i.e) : (u = Ie, m = Pe, l = Te(n.e / m) - Te(i.e / m)), T = k.length, O = B.length, y = new S(z), x = y.d = [], p = 0; k[p] == (B[p] || 0); p++);
                    if (k[p] > (B[p] || 0) && l--, null == o ? (E = o = S.precision, a = S.rounding) : E = s ? o + (n.e - i.e) + 1 : o, 0 > E) x.push(1), d = !0;
                    else {
                        if (E = E / m + 2 | 0, p = 0, 1 == T) {
                            for (h = 0, k = k[0], E++;
                                (O > p || h) && E--; p++) M = h * u + (B[p] || 0), x[p] = M / k | 0, h = M % k | 0;
                            d = h || O > p
                        } else {
                            for (h = u / (k[0] + 1) | 0, h > 1 && (k = e(k, h, u), B = e(B, h, u), T = k.length, O = B.length), A = T, b = B.slice(0, T), w = b.length; T > w;) b[w++] = 0;
                            C = k.slice(), C.unshift(0), _ = k[0], k[1] >= u / 2 && ++_;
                            do h = 0, c = t(k, b, T, w), 0 > c ? (N = b[0], T != w && (N = N * u + (b[1] || 0)), h = N / _ | 0, h > 1 ? (h >= u && (h = u - 1), g = e(k, h, u), v = g.length, w = b.length, c = t(g, b, v, w), 1 == c && (h--, r(g, v > T ? C : k, v, u))) : (0 == h && (c = h = 1), g = k.slice()), v = g.length, w > v && g.unshift(0), r(b, g, w, u), -1 == c && (w = b.length, c = t(k, b, T, w), 1 > c && (h++, r(b, w > T ? C : k, w, u))), w = b.length) : 0 === c && (h++, b = [0]), x[p++] = h, c && b[0] ? b[w++] = B[A] || 0 : (b = [B[A]], w = 1); while ((A++ < O || void 0 !== b[0]) && E--);
                            d = void 0 !== b[0]
                        }
                        x[0] || x.shift()
                    }
        ...
        function n(e, t, r, n, a) {
            ...
            }, s.createProxy(a), a.on("import", function(e, t, r) {
                void 0 === r && c(e, t)
            }), s
        }
        var i = r(23).format,
        ...
        function n(e, r) {
            if (Array.isArray(e)) {
                for (var i = "[", o = e.length, a = 0; o > a; a++) 0 != a && (i += ", "), i += n(e[a], r);
                return i += "]"
            }
            return t.format(e, r)
        }
        ...
        t.format = function(e, r) {
            ...
            switch (void 0 !== r && (r.notation && (n = r.notation), "number" == typeof r ? i = r : r.precision && (i = r.precision)), n) {
                ...
                case "auto":
                    var o = .001,
                        a = 1e5;
                    r && r.exponential && (void 0 !== r.exponential.lower && (o = r.exponential.lower), void 0 !== r.exponential.upper && (a = r.exponential.upper));
                    ({
                ...
                switch (arguments.length) {
                    ...
                    case 2:
                        var r = arguments[0],
                            n = arguments[1];
                        if (a(r)) {
                            if (n && n.isUnit && n.hasBase("ANGLE") && (n = n.toNumber("rad")), a(n)) return new i({
                                r: r,
                                phi: n
                            });
            ...
            ! function(o) {
                        ...
                        if (void 0 === e || null === e) u.re = u.im = 0;
                            ...
                            case "string":
                                ...
                                for (var o = 0; o < r.length; o++) {
                                    var a = r[o];
                                    " " === a || "	" === a || "\n" === a || ("+" === a ? n++ : "-" === a ? i++ : "i" === a || "I" === a ? (n + i === 0 && c(), " " === r[o + 1] || isNaN(r[o + 1]) ? u.im += parseFloat((i % 2 ? "-" : "") + "1") : (u.im += parseFloat((i % 2 ? "-" : "") + r[o + 1]), o++), n = i = 0) : ((n + i === 0 || isNaN(a)) && c(), "i" === r[o + 1] || "I" === r[o + 1] ? (u.im += parseFloat((i % 2 ? "-" : "") + a), o++) : u.re += parseFloat((i % 2 ? "-" : "") + a), n = i = 0))
                                }
                                n + i > 0 && c();
                                break;
                            case "number":
                ...
                s.prototype = {
                    ...
                    div: function(e, t) {
                        ...
                        var r, n, i = u.re,
                            o = u.im;
                        return 0 === i && 0 === o ? new s(0 !== e ? e / 0 : 0, 0 !== t ? t / 0 : 0) : 0 === o ? new s(e / i, t / i) : Math.abs(i) < Math.abs(o) ? (n = i / o, r = i * n + o, new s((e * n + t) / r, (t * n - e) / r)) : (n = o / i, r = o * n + i, new s((e + t * n) / r, (t - e * n) / r))
                    },
                    pow: function(e, t) {
                    ...
                    atanh: function() {
                        var e = this.re,
                            ...
                            i = 1 + e,
                            o = n * n + t * t,
                            u = 0 !== o ? new s((i * n - t * t) / o, (t * n + i * t) / o) : new s(-1 !== e ? e / 0 : 0, 0 !== t ? t / 0 : 0),
                            c = u.re;
            ...
            ! function(o) {
                ...
                var c = 2e3,
                    ...
                    l = function(e, t) {
                        ...
                        if (void 0 === e || null === e);
                            ...
                            case "object":
                                "d" in e && "n" in e ? (n = e.n, i = e.d, "s" in e && (n *= e.s)) : 0 in e ? (n = e[0], 1 in e && (i = e[1])) : s(), o = n * i;
                                break;
                            case "number":
                                ...
                                break;
                            case "string":
                                if (d = e.match(/\d+|./g), "-" === d[m] ? (o = -1, m++) : "+" === d[m] && m++, d.length === m + 1 ? c = a(d[m++], o) : "." === d[m + 1] || "." === d[m] ? ("." !== d[m] && (u = a(d[m++], o)), m++, (m + 1 === d.length || "(" === d[m + 1] && ")" === d[m + 3] || "'" === d[m + 1] && "'" === d[m + 3]) && (c = a(d[m], o), p = Math.pow(10, d[m].length), m++), ("(" === d[m] && ")" === d[m + 2] || "'" === d[m] && "'" === d[m + 2]) && (l = a(d[m + 1], o), h = Math.pow(10, d[m + 1].length) - 1, m += 3)) : "/" === d[m + 1] || ":" === d[m + 1] ? (c = a(d[m], o), p = a(d[m + 2], 1), m += 3) : "/" === d[m + 3] && " " === d[m + 1] && (u = a(d[m], o), c = a(d[m + 2], o), p = a(d[m + 4], 1), m += 5), d.length <= m) {
                                    i = p * h, o = n = l + i * u + h * c;
                                    break
                                }
                                default:
                ...
                u.REDUCE = 1, u.prototype = {
                    ...
                    toString: function() {
                        ...
                        for (var n = String(t).split(""), i = 0, o = [~this.s ? "" : "-", "", ""], a = "", s = h(t, r), c = m(t, r, s), f = -1, l = 1, p = 15 + s + c + n.length, g = 0; p > g; g++, i *= 10) {
                            ...
                            i >= r ? (o[l] += a + (i / r | 0), a = "", i %= r) : l > 1 ? a += "0" : o[l] && (o[l] += "0")
                        }
        ...
        function i(e, r, n, o) {
            ...
            if (e.length = c, n < r.length - 1) {
                var l = n + 1;
                for (a = 0; f > a; a++) s = e[a], Array.isArray(s) || (s = [s], e[a] = s), i(s, r, l, o);
        ...
        t.size = function(e) {
            ...
            var o = i || t.size(e);
            if (n)
                for (var s = 0; n > s; s++) e = [e], o.unshift(1);
        ...
        function n(e, t, n, c) {
            ...
            function g(e, t) {
                ...
                for (var i = t.min(), a = t.max(), s = 0, u = e._size.length; u > s; s++) m(i[s], e._size[s]), m(a[s], e._size[s]);
            ...
            return d.prototype.clone = function() {
                ...
                for (var t = e > 0 ? e : 0, r = 0 > e ? -e : 0, n = this._size[0], i = this._size[1], o = Math.min(n - r, i - t), a = [], s = 0; o > s; s++) a[s] = this._data[s + r][s + t];
                return new d({
                    data: a,
                    size: [o],
                    datatype: this._datatype
        ...
        function n(e, t, n, d) {
                    ...
                    if (h(r) && (o = d.find(y, [r, r]) || y, a = d.convert(0, r)), n > 0) {
                        ...
                        do {
                            ...
                            for (var u = 0; n > u; u++) {
                                ...
                                } else 0 === s && 1 > i && (i = 1), o(c, a) || (e._values.push(c), e._index.push(u))
                            }
                            s++
                        } while (i > s)
                    }
            ...
            var w = function(e, t) {
                ...
                N = function(e, t, r, n) {
                    ...
                    var i, u = t.size(),
                        c = t.isScalar();
                    if (r && r.isMatrix === !0 ? (i = r.size(), r = r.toArray()) : i = a.size(r), c) {
                        if (0 !== i.length) throw new TypeError("Scalar expected");
                        e.set(t.min(), r, n)
                    } else {
            ...
            g.prototype.get = function(e) {
                ...
                var n = e[0],
                    ...
                    u = y,
                    c = 0;
                h(this._datatype) && (u = d.find(y, [this._datatype, this._datatype]) || y, c = d.convert(0, this._datatype)), (n > a - 1 || i > s - 1) && (O(this, Math.max(n + 1, a), Math.max(i + 1, s), r), a = this._size[0], s = this._size[1]), m(n, a), m(i, s);
            ...
            var O = function(e, t, r, n) {
                var i = n || 0,
                    o = y,
                    a = 0;
                h(e._datatype) && (o = d.find(y, [e._datatype, e._datatype]) || y, a = d.convert(0, e._datatype), i = d.convert(i, e._datatype));
                var s, u, c, f = !o(i, a),
                    l = e._size[0],
                    p = e._size[1];
                if (r > p) {
            ...
            g.prototype.forEach = function(e, t) {
                ...
                for (var r = this, n = this._size[0], i = this._size[1], o = 0; i > o; o++) {
                    for (var a = this._ptr[o], s = this._ptr[o + 1], u = 0, c = a; s > c; c++) {
                        var f = this._index[c];
                        if (!t)
                            for (var l = u; f > l; l++) e(0, [l, o], r);
                        e(this._values[c], [f, o], r), u = f + 1
                    }
                    if (!t)
                        for (var p = u; n > p; p++) e(0, [p, o], r)
                }
            ...
            var T = function(e, t, r, n, i) {
                var o, a, u = n[0],
                    ...
                    f = [];
                for (o = 0; u > o; o++)
                    for (f[o] = [], a = 0; c > a; a++) f[o][a] = 0;
                for (a = 0; c > a; a++)
                    for (var l = r[a], p = r[a + 1], h = l; p > h; h++) o = t[h], f[o][a] = e ? i ? s.clone(e[h]) : e[h] : 1;
                return f
            };
            return g.prototype.format = function(e) {
                for (var t = this._size[0], r = this._size[1], n = this.density(), i = "Sparse Matrix [" + u.format(t, e) + " x " + u.format(r, e) + "] density: " + u.format(n, e) + "\n", o = 0; r > o; o++)
                    for (var a = this._ptr[o], s = this._ptr[o + 1], c = a; s > c; c++) {
                        var f = this._index[c];
                        i += "\n    (" + u.format(f, e) + ", " + u.format(o, e) + ") ==> " + (this._values ? u.format(this._values[c], e) : "X")
                    }
                return i
        ...
        function n(e, t, n) {
            ...
            return i.prototype.type = "Spa", i.prototype.isSpa = !0, i.prototype.set = function(e, t) {
                ...
                var n = this._heap,
                    ...
                    o = [],
                    s = n.extractMinimum();
                for (s && o.push(s); s && s.key <= t;) s.key >= e && (a(s.value, 0) || r(s.key, s.value, this)), s = n.extractMinimum(), s && o.push(s);
            ...
            var o = e.DenseMatrix,
                a = function(e, t, r, a) {
                    ...
                    var N = [],
                        E = [];
                    for (g = 0; y > g; g++) {
                        for (var M = g + 1, A = p[g], O = p[g + 1], _ = A; O > _; _++) d = l[_], N[d] = a ? b(f[_], s[d][g]) : b(s[d][g], f[_]), E[d] = M;
            ...
            var a = n(r(48)),
                ...
                u = function(e, t, r) {
                    ...
                    var v, y = f[0],
                        ...
                        w = 0,
                        N = r;
                    "string" == typeof l && l === g && (v = l, b = o.find(a, [v, v]), w = o.convert(0, v), N = o.find(r, [v, v]));
                    var E, M, A, O, _, T = n && p ? [] : void 0,
                        C = [],
                        S = [],
                        z = new s({
                            values: T,
                    ...
                    for (M = 0; x > M; M++) {
                        S[M] = C.length;
                        var R = M + 1;
                        for (O = c[M], _ = c[M + 1], A = O; _ > A; A++) E = u[A], C.push(E), I[E] = R, B && (B[E] = n[A]);
                        ...
                        if (B && k)
                            for (A = S[M]; A < C.length;) E = C[A], I[E] === R ? (T[A] = B[E], A++) : P[E] === R ? (T[A] = k[E], A++) : C.splice(A, 1)
                    }
            ...
            var i = e.DenseMatrix,
                o = function(e, t, r, o) {
                    ...
                    for (var d = [], g = new i({
                        ...
                        for (var A = 0; p > A; A++) 0 === x && (d[A] = []), y[A] === b ? d[A][x] = o ? m(t, v[A]) : m(v[A], t) : d[A][x] = t
                    }
                    return g
                };
            return o
        ...
        function n(e, t, r, n) {
            var i = e.DenseMatrix,
                ...
                s = function(e, t, r, n, i, o) {
                    var a = [];
                    if (t === r.length - 1)
                        for (var u = 0; n > u; u++) a[u] = e(i[u], o[u]);
                    else
                        for (var c = 0; n > c; c++) a[c] = s(e, t + 1, r, r[t + 1], i[c], o[c]);
                    return a
                };
            return a
        }
        ...
        function n(e, t, r, n) {
            var o = e.DenseMatrix,
                ...
                s = function(e, t, r, n, i, o, a) {
                    var u = [];
                    if (t === r.length - 1)
                        for (var c = 0; n > c; c++) u[c] = a ? e(o, i[c]) : e(i[c], o);
                    else
                        for (var f = 0; n > f; f++) u[f] = s(e, t + 1, r, r[t + 1], i[f], o, a);
                    return u
                };
            return a
        }
        ...
        function n(e, t, n, i) {
            ...
            var c = function(e, t, r) {
                ...
                h = function(e, t) {
                    ...
                    e = null;
                    for (var m = 0; r > m; m++) c = n[m], c && (e ? (c.left.right = c.right, c.right.left = c.left, c.left = e, c.right = e.right, e.right = c, c.right.left = c, a(c.key, e.key) && (e = c)) : e = c);
                    return e
                };
            return o
        }
            ...
            var o = e.DenseMatrix,
                a = function(e, t, r, a) {
                    ...
                    for (var N = [], E = [], M = 0; v > M; M++) {
                        ...
                        for (var S = 0; g > S; S++) E[S] === A ? b[S][M] = N[S] : b[S][M] = a ? x(y, s[S][M]) : x(s[S][M], y)
                    }
                    return new o({
                        data: b,
                        size: [g, v],
            ...
            var i = e.DenseMatrix,
                o = function(e, t, r, o) {
                    ...
                    for (var d = [], g = new i({
                        ...
                        for (var A = 0; p > A; A++) 0 === x && (d[A] = []), y[A] === b ? d[A][x] = o ? m(t, v[A]) : m(v[A], t) : d[A][x] = o ? m(t, 0) : m(0, t)
                    }
                    return g
                };
            return o
        ...
        function n(e) {
            ...
            function r(t) {
                for (var r = 0, n = t.length; n > r; r++)
                    if ("number" != typeof t[r] || !o(t[r])) throw new TypeError("Index parameters must be positive integer numbers");
        ...
        function n(e, t, r, n) {
            ...
            return o.prototype.type = "Range", o.prototype.isRange = !0, o.parse = function(e) {
                ...
                var e = 0,
                    ...
                    n = this.end,
                    o = n - t;
                return i.sign(r) == i.sign(o) ? e = Math.ceil(o / r) : 0 == o && (e = 0), isNaN(e) && (e = 0), [e]
            }, o.prototype.min = function() {
                var e = this.size()[0];
        ...
        function n(e, t, n, s, u) {
            function c(e, t) {
                ...
                if (void 0 !== e && !C(e) && !e.isComplex) throw new TypeError("First parameter in Unit constructor must be number, BigNumber, Fraction, Complex, or undefined");
            ...
            function g() {
                for (var e = "", t = I.charCodeAt(P); t >= 48 && 57 >= t || t >= 65 && 90 >= t || t >= 97 && 122 >= t;) e += R, h(), t = I.charCodeAt(P);
            ...
            c.parse = function(r, n) {
                if (n = n || {}, I = r, P = -1, R = "", "string" != typeof I) throw new TypeError("Invalid argument in Unit.parse, string expected");
                var i = new c;
                i.units = [], h(), f();
                var o = d(),
                    a = null;
                o && (a = "BigNumber" === t.number ? new e.BigNumber(o) : "Fraction" === t.number ? new e.Fraction(o) : parseFloat(o)), f();
                for (var s = 1, u = !1, l = [], p = 1;;) {
                    for (f();
                        "(" === R;) l.push(s), p *= s, s = 1, h(), f();
                    if (!R) break;
                    var m = R,
                        x = g();
                    if (null == x) throw new SyntaxError('Unexpected "' + m + '" in "' + I + '" at index ' + P.toString());
                    var b = y(x);
                    ...
                    for (f();
                        ")" === R;) {
                        if (0 === l.length) throw new SyntaxError('Unmatched ")" in "' + I + '" at index ' + P.toString());
                        p /= l.pop(), h(), f()
                    }
                ...
                if (this._isDerived()) {
                    ...
                    for (var s = 0; s < this.units.length; s++) t = o(this.units[s].unit.value), i = o(this.units[s].prefix.value), n = o(this.units[s].power), a = E(a, A(E(t, i), n));
                    return a
                }
                return o = c._getNumberConverter(z(e)), t = o(this.units[0].unit.value), r = o(this.units[0].unit.offset), i = o(this.units[0].prefix.value), E(w(e, r), E(t, i))
                ...
                if (this._isDerived()) {
                    ...
                    for (var u = 0; u < this.units.length; u++) r = a(this.units[u].unit.value), o = a(this.units[u].prefix.value), i = a(this.units[u].power), s = M(s, A(E(r, o), i));
                    return s
                }
                return a = c._getNumberConverter(z(e)), r = a(this.units[0].unit.value), o = a(this.units[0].prefix.value), n = a(this.units[0].unit.offset), void 0 == t ? N(M(M(e, r), o), n) : N(M(M(e, r), t), n)
                ...
                for (var t = this.clone(), r = 0; r < j.length; r++) t.dimensions[r] = (this.dimensions[r] || 0) + (e.dimensions[r] || 0);
                ...
                for (var t = this.clone(), r = 0; r < j.length; r++) t.dimensions[r] = (this.dimensions[r] || 0) * e;
            ...
            c.prototype.abs = function() {
                ...
                if (e && e.isUnit) {
                    ...
                    return t = e.clone(), t.value = o(r), t.fixPrefix = !0, t.isUnitListSimplified = !0, t
                }
                    ...
                    for (var n in V)
                        ...
                        if (i) this.units = [{
                            ...
                            for (var o = !1, a = 0; a < j.length; a++) {
                                var s = j[a];
                                Math.abs(this.dimensions[a] || 0) > 1e-12 && (V.hasOwnProperty(s) ? t.push({
                                    unit: V[s].unit,
                                    prefix: V[s].prefix,
            ...
            Z.cgs = JSON.parse(JSON.stringify(Z.si)), Z.cgs.LENGTH = {
                unit: G.m,
                prefix: q.SHORT.c
            }, Z.cgs.MASS = {
                unit: G.g,
                ...
                unit: G.erg,
                prefix: q.NONE[""]
            }, Z.us = JSON.parse(JSON.stringify(Z.si)), Z.us.LENGTH = {
                unit: G.ft,
                prefix: q.NONE[""]
            }, Z.us.MASS = {
                unit: G.lbm,
            ...
            c.setUnitSystem = function(e) {
                if (!Z.hasOwnProperty(e)) throw new Error("Unit system " + e + " does not exist. Choices are: " + Object.keys(Z).join(", "));
                V = Z[e]
            ...
            for (var W in H)
                ...
                if (a)
                    for (var u = 0; u < a.length; u++)
                        if (G.hasOwnProperty(a[u])) throw new Error('Cannot create alias "' + a[u] + '": a unit with that name already exists');
                ...
                a = a || [], s = s || 0, i = i && i.toUpperCase ? q[i.toUpperCase()] || q.NONE : q.NONE;
                var l = {};
                if (o) {
                    l = {
                        name: e,
                    ...
                    var d = e + "_STUFF";
                    if (j.indexOf(d) >= 0) throw new Error('Cannot create new base unit "' + e + '": a base unit with that name already exists (and cannot be overridden)');
                    j.push(d);
                    for (var v in F) F.hasOwnProperty(v) && (F[v].dimensions[j.length - 1] = 0);
                    for (var g = {
                            dimensions: []
                        }, u = 0; u < j.length; u++) g.dimensions[u] = 0;
                    g.dimensions[j.length - 1] = 1, g.key = d, F[d] = g, l = {
                        name: e,
                        value: 1,
            ...
            var a = n(r(48)),
                ...
                u = function(e, t, r) {
                    ...
                    for (M = 0; x > M; M++) {
                        C[M] = T.length;
                        var P = M + 1;
                        for (A = c[M], O = c[M + 1]; O > A; A++) E = u[A], T.push(E), k[E] = P, z && (z[E] = n[A]);
                        for (A = m[M], O = m[M + 1]; O > A; A++) E = h[A], k[E] !== P && T.push(E), I[E] = P, B && (B[E] = p[A]);
                        if (_)
        ...
        function n(e, t, n, a) {
            function s(r, n) {
                if (t.predictable && !i(n) && 0 > r) try {
                    var o = m(n),
                        a = d(o);
                    if ((n === a || Math.abs((n - a) / n) < 1e-14) && o.d % 2 === 1) return (o.n % 2 === 0 ? 1 : -1) * Math.pow(-r, n)
                } catch (s) {}
            ...
            function u(e, t) {
                ...
                for (var n = l(r[0]).valueOf(), a = e; t >= 1;) 1 == (1 & t) && (n = p(a, n)), t >>= 1, a = p(a, a);
                return n
            }
        ...
        function n(e, t, n, a) {
            ...
            function u(t, r, n) {
                var a = t && t.isBigNumber === !0 ? e.BigNumber : r && r.isBigNumber === !0 ? e.BigNumber : null;
                if (t && t.isBigNumber === !0 && (t = t.toNumber()), r && r.isBigNumber === !0 && (r = r.toNumber()), !o(t) || 1 > t) throw new Error("Parameters in function eye must be positive integers");
                if (!o(r) || 1 > r) throw new Error("Parameters in function eye must be positive integers");
            ...
            var s = r(32),
                ...
                y = function(e, t, r) {
                    ...
                    var n, i = e._data,
                        ...
                        l = c,
                        p = f;
                    o && u && o === u && "string" == typeof o && (n = o, l = a.find(c, [n, n]), p = a.find(f, [n, n]));
                ...
                b = function(e, t) {
                    var r, n = e._data,
                        ...
                        d = c,
                        g = f;
                    o && l && o === l && "string" == typeof o && (r = o, d = a.find(c, [r, r]), g = a.find(f, [r, r]));
                    for (var v = [], y = 0; h > y; y++) {
                ...
                E = function(e, t) {
                    var r, n = e._data,
                        ...
                        h = c,
                        d = f;
                    o && u && o === u && "string" == typeof o && (r = o, h = a.find(c, [r, r]), d = a.find(f, [r, r]));
                    for (var g = [], v = 0; l > v; v++) {
                ...
                M = function(e, t) {
                    var r, n = e._data,
                        ...
                        g = c,
                        v = f;
                    o && l && o === l && "string" == typeof o && (r = o, g = a.find(c, [r, r]), v = a.find(f, [r, r]));
                    for (var y = [], x = 0; p > x; x++) {
                        var b = n[x];
                        y[x] = [];
                        for (var w = 0; d > w; w++) {
                ...
                A = function(e, t) {
                    ...
                    var m, g = n[0],
                        ...
                        b = l,
                        w = 0;
                    i && h && i === h && "string" == typeof i && (m = i, y = a.find(c, [m, m]), x = a.find(f, [m, m]), b = a.find(l, [m, m]), w = a.convert(0, m));
                ...
                O = function(e, t) {
                    ...
                    var s, u = t._data,
                        ...
                        w = l,
                        N = 0;
                    o && p && o === p && "string" == typeof o && (s = o, x = a.find(c, [s, s]), b = a.find(f, [s, s]), w = a.find(l, [s, s]), N = a.convert(0, s));
                    var E = [],
                        M = [];
                    y[0] = 0;
                    for (var A = 0; m > A; A++) {
                        ...
                        if (!w(O, N))
                            for (var _ = i[A], T = i[A + 1], C = _; T > C; C++) {
                                var S = n[C];
                                M[S] ? E[S] = x(E[S], b(O, r[C])) : (M[S] = !0, v.push(S), E[S] = b(O, r[C]))
                            }
                    }
                ...
                _ = function(e, t) {
                    ...
                    var s, u = t._data,
                        ...
                        x = l,
                        b = 0;
                    o && p && o === p && "string" == typeof o && (s = o, v = a.find(c, [s, s]), y = a.find(f, [s, s]), x = a.find(l, [s, s]), b = a.convert(0, s));
                        ...
                        for (var T = _ + 1, C = 0; m > C; C++) {
                            ...
                            if (!x(S, b))
                                for (var z = i[C], B = i[C + 1], k = z; B > k; k++) {
                                    var I = n[k];
                                    O[I] !== T ? (O[I] = T, N.push(I), A[I] = y(S, r[k])) : A[I] = v(A[I], y(S, r[k]))
                                }
                        }
                ...
                T = function(e, t) {
                    var r, n = e._values,
                        ...
                        y = c,
                        x = f;
                    s && h && s === h && "string" == typeof s && (r = s, y = a.find(c, [r, r]), x = a.find(f, [r, r]));
                    for (var b, w, N, E, M, A, O, _, T = v ? [] : void 0, C = [], S = [], z = new d({
                            values: T,
                            index: C,
                            ptr: S,
                            size: [m, g],
                        ...
                        for (M = p[I], A = p[I + 1], E = M; A > E; E++)
                            if (_ = l[E], v)
                                for (w = o[_], N = o[_ + 1], b = w; N > b; b++) O = i[b], k[O] !== P ? (k[O] = P, C.push(O), B[O] = x(u[E], n[b])) : B[O] = y(B[O], x(u[E], n[b]));
                            else
                                for (w = o[_], N = o[_ + 1], b = w; N > b; b++) O = i[b], k[O] !== P && (k[O] = P, C.push(O));
                        if (v)
            ...
            var o = n(r(48)),
                ...
                s = function(e, t, r, n) {
                    ...
                    var p, h = f[0],
                        ...
                        g = 0,
                        v = r;
                    "string" == typeof l && (p = l, d = i.find(o, [p, p]), g = i.convert(0, p), t = i.convert(t, p), v = i.find(r, [p, p]));
                    for (var y = [], x = [], b = [], w = new a({
                            values: y,
                            index: x,
                            ptr: b,
                            size: [h, m],
        ...
        (function(e, n) {
            function i(e, r) {
                ...
                return arguments.length >= 3 && (n.depth = arguments[2]), arguments.length >= 4 && (n.colors = arguments[3]), d(r) ? n.showHidden = r : r && t._extend(n, r), w(n.showHidden) && (n.showHidden = !1), w(n.depth) && (n.depth = 2), w(n.colors) && (n.colors = !1), w(n.customInspect) && (n.customInspect = !0), n.colors && (n.stylize = o), u(n, e, n.depth)
            }
            ...
            function u(e, r, n) {
                ...
                var a = Object.keys(r),
                    d = s(a);
                if (e.showHidden && (a = Object.getOwnPropertyNames(r)), A(r) && (a.indexOf("message") >= 0 || a.indexOf("description") >= 0)) return f(r);
                if (0 === a.length) {
                    if (O(r)) {
                        var g = r.name ? ": " + r.name : "";
                ...
                if (N(r) && (v = " " + RegExp.prototype.toString.call(r)), M(r) && (v = " " + Date.prototype.toUTCString.call(r)), A(r) && (v = " " + f(r)), 0 === a.length && (!y || 0 == r.length)) return b[0] + v + b[1];
                if (0 > n) return N(r) ? e.stylize(RegExp.prototype.toString.call(r), "regexp") : e.stylize("[Object]", "special");
                e.seen.push(r);
                var E;
                return E = y ? l(e, r, n, d, a) : a.map(function(t) {
            ...
            function l(e, t, r, n, i) {
                for (var o = [], a = 0, s = t.length; s > a; ++a) z(t, String(a)) ? o.push(p(e, t, r, n, String(a), !0)) : o.push("");
            ...
            function p(e, t, r, n, i, o) {
                ...
                if (c = Object.getOwnPropertyDescriptor(t, i) || {
                        value: t[i]
                    }, c.get ? s = c.set ? e.stylize("[Getter/Setter]", "special") : e.stylize("[Getter]", "special") : c.set && (s = e.stylize("[Setter]", "special")), z(n, i) || (a = "[" + i + "]"), s || (e.seen.indexOf(c.value) < 0 ? (s = g(r) ? u(e, c.value, null) : u(e, c.value, r - 1), s.indexOf("\n") > -1 && (s = o ? s.split("\n").map(function(e) {
                        return "  " + e
                    }).join("\n").substr(2) : "\n" + s.split("\n").map(function(e) {
                        return "   " + e
            ...
            t.format = function(e) {
                ...
                for (var r = 1, n = arguments, o = n.length, a = String(e).replace(B, function(e) {
                        if ("%%" === e) return "%";
                        if (r >= o) return e;
                        switch (e) {
                            case "%s":
                    ...
                    }), s = n[r]; o > r; s = n[++r]) a += g(s) || !E(s) ? " " + s : " " + i(s);
                return a
            ...
            t.debuglog = function(e) {
                ...
                date: "magenta",
                regexp: "red"
            }, t.isArray = m, t.isBoolean = d, t.isNull = g, t.isNullOrUndefined = v, t.isNumber = y, t.isString = x, t.isSymbol = b, t.isUndefined = w, t.isRegExp = N, t.isObject = E, t.isDate = M, t.isError = A, t.isFunction = O, t.isPrimitive = _, t.isBuffer = r(94);
        ...
        function n(e, t, n, a) {
            ...
            function A() {
                for (var e = O();
                    "and" == xe;) h(), e = new se("and", "and", [e, O()]);
                return e
            }

            function O() {
                for (var e = _();
                    "|" == xe;) h(), e = new se("|", "bitOr", [e, _()]);
                return e
            }
            ...
            function R() {
                var e, t, r, n;
                return e = U(), "^" != xe && ".^" != xe || (t = xe, r = "^" == t ? "pow" : "dotPow", h(), n = [e, P()], e = new se(t, r, n)), e
            }
                ...
                if ("[" == xe) {
                    if (m(), p(), "]" != xe) {
                        ...
                        if (";" == xe) {
                            ...
                            for (var o = 1; r > o; o++)
                                if (t[o].items.length != n) throw J("Column dimensions mismatch (" + t[o].items.length + " != " + n + ")");
                            e = new K(t)
                        } else {
                            if ("]" != xe) throw X("End of matrix ] expected");
                            d(), p(), e = i
        ...
        function n(e, t, n, i) {
            ...
            var s = n(r(281)),
                u = n(r(283));
            return o.prototype = new s, o.prototype.type = "AccessorNode", o.prototype.isAccessorNode = !0, o.prototype._compile = function(e, t) {
                e.access = u;
            ...
            var p = n(r(52)),
                h = c("subset", {
                    ...
                    "Array, Index, any": function(e, t, r) {
                        return p(a(e)).subset(t, r, void 0).valueOf()
                    },
        ...
        function n(e, t, n, i) {
            ...
            var a = n(r(281));
            return o.prototype = new a, o.prototype.type = "ArrayNode", o.prototype.isArrayNode = !0, o.prototype._compile = function(e, t) {
        ...
        function n(e, t, n, i) {
            ...
            var s = n(r(281)),
                ...
                c = n(r(283)),
                f = (r(282), r(289));
            return o.prototype = new s, o.prototype.type = "AssignmentNode", o.prototype.isAssignmentNode = !0, o.prototype._compile = function(e, t) {
                e.assign = u, e.access = c;
                var r, n = this.object._compile(e, t),
                    i = this.index ? this.index._compile(e, t) : null,
                    o = this.value._compile(e, t);
                if (this.index) {
                    if (this.index.isObjectProperty()) return n + '["' + this.index.getObjectProperty() + '"] = ' + o;
                    if (this.object.isSymbolNode) return r = this.index.needsSize() ? "var size = math.size(object).valueOf();" : "", "(function () {  var object = " + n + ";  var value = " + o + ";  " + r + '  scope["' + this.object.name + '"] = assign(object, ' + i + ", value);  return value;})()";
                    ...
                    if (this.object.index.isObjectProperty()) {
                        ...
                        return "(function () {  var parent = " + a + ";  var object = parent" + s + ";  var value = " + o + ";" + r + "  parent" + s + " = assign(object, " + i + ", value);  return value;})()"
                    }
                    var f = this.object.index.needsSize() ? "var size = math.size(parent).valueOf();" : "",
                        l = this.object.index._compile(e, t);
                    return "(function () {  var parent = " + a + ";  " + f + "  var parentIndex = " + l + ";  var object = access(parent, parentIndex);  var value = " + o + ";  " + r + "  assign(parent, parentIndex, assign(object, " + i + ", value));  return value;})()"
                }
                ...
                return a(this, e && e.parenthesis) && (n = "\\left(" + n + "\\right)"), t + r + ":=" + n
            }, o
        }
        r(32);
        ...
        e.exports.properties = o, e.exports.getPrecedence = r, e.exports.getAssociativity = n, e.exports.isAssociativeWith = i
    }, function(e, t, r) {
        "use strict";
        ...
        function n(e, t, n, i) {
            ...
            var a = n(r(281)),
                s = n(r(72));
            return o.prototype = new a, o.prototype.type = "BlockNode", o.prototype.isBlockNode = !0, o.prototype._compile = function(e, t) {
                e.ResultSet = s;
        ...
        function n(e, t, n, o) {
            ...
            var s = n(r(281));
            return a.prototype = new s, a.prototype.type = "ConditionalNode", a.prototype.isConditionalNode = !0, a.prototype._compile = function(e, t) {
                ...
                ("all" === t || "OperatorNode" === this.condition.type || null !== o && r >= o) && (n = "(" + n + ")");
                var a = this.trueExpr.toString(e),
                    s = i.getPrecedence(this.trueExpr, t);
                ("all" === t || "OperatorNode" === this.trueExpr.type || null !== s && r >= s) && (a = "(" + a + ")");
                var u = this.falseExpr.toString(e),
                    c = i.getPrecedence(this.falseExpr, t);
                return ("all" === t || "OperatorNode" === this.falseExpr.type || null !== c && r >= c) && (u = "(" + u + ")"), n + " ? " + a + " : " + u
            }, a.prototype._toTex = function(e) {
        ...
        function n(e, t, n, o) {
            ...
            return a.prototype = new s, a.prototype.type = "ConstantNode", a.prototype.isConstantNode = !0, a.prototype._compile = function(e, t) {
        ...
        function n(e, t, n, s) {
            ...
            return u.prototype = new f, u.prototype.type = "FunctionAssignmentNode", u.prototype.isFunctionAssignmentNode = !0, u.prototype._compile = function(e, t) {
                ...
                var t = e && e.parenthesis ? e.parenthesis : "keep",
                    r = this.expr.toTex(e);
                return c(this, t) && (r = "\\left(" + r + "\\right)"), "\\mathrm{" + this.name + "}\\left(" + this.params.map(o.toSymbol).join(",") + "\\right):=" + r
            }, u
        }
        var i = r(282),
            o = r(32),
        ...
        function n(e, t, n, i) {
            ...
            var a = n(r(281)),
                ...
                u = Array.isArray;
            return o.prototype = new a, o.prototype.type = "IndexNode", o.prototype.isIndexNode = !0, o.prototype._compile = function(e, t) {
                var r = Object.create(t);
        ...
        function n(e, t, n, o) {
            ...
            var u = n(r(281));
            return a.prototype = new u, a.prototype.type = "RangeNode", a.prototype.isRangeNode = !0, a.prototype.needsEnd = function() {
        ...
        function n(e, t, n, i) {
            ...
            var a = n(r(281));
            return o.prototype = new a, o.prototype.type = "ObjectNode", o.prototype.isObjectNode = !0, o.prototype._compile = function(e, t) {
                var r = [];
                ...
                switch (n.length) {
                    case 1:
                        var a = o.getAssociativity(this, t),
                            s = n[0].toString(e);
                        return i[0] && (s = "(" + s + ")"), "right" === a ? this.op + s : "left" === a ? s + this.op : s + this.op;
                    case 2:
                ...
                switch (s = "undefined" == typeof s ? this.op : s, n.length) {
                    case 1:
                        var u = o.getAssociativity(this, t),
                            f = n[0].toTex(e);
                        return a[0] && (f = "\\left(" + f + "\\right)"), "right" === u ? s + f : "left" === u ? f + s : f + s;
                    case 2:
                        var l = n[0],
                            p = l.toTex(e);
                        a[0] && (p = "\\left(" + p + "\\right)");
        ...
        function n(e, t, n, o, a) {
            ...
            return s.prototype.toTex = function(e) {
                ...
                !a[this.name] || "function" != typeof a[this.name].toTex && "object" != typeof a[this.name].toTex && "string" != typeof a[this.name].toTex || (t = a[this.name].toTex);
                var n;
                switch (typeof t) {
                    case "function":
                        n = t(this, e);
        ...
        e.exports = [r(280), r(286), r(287), r(290), r(291), r(292), r(294), r(293), r(299), r(281), r(297), r(298), r(300), r(295), r(296), r(307)]
    }, function(e, t) {
        "use strict";
                    ...
                    "...Array | Matrix | number | BigNumber": function(e) {
                        ...
                        for (t = 0; n > t; t++) {
                            ...
                            if (m && m.isMatrix === !0 && (p = !0), "number" == typeof m || m && m.isBigNumber === !0) {
                                ...
                                if (r = f, f = m.valueOf(), !a(f)) throw new TypeError("Integer number expected for dimension");
                    ...
                    "Array | Matrix": function(e) {
                        ...
                        switch (t.length) {
                            ...
                            case 2:
                                var r = t[0],
                                    n = t[1];
                                if (r == n) return e.isMatrix === !0 ? s(a(e.valueOf(), r, n), e.storage()) : a(e, r, n);
                                throw new RangeError("Matrix must be square (size: " + i.string.format(t) + ")");
                            default:
        ...
        function n(e, t, n, i) {
            ...
            function a(r, n) {
                ...
                var a;
                return "BigNumber" === t.number ? (a = n ? f : c, o(a(new e.BigNumber(i.start), new e.BigNumber(i.end), new e.BigNumber(i.step)))) : (a = n ? u : s, o(a(i.start, i.end, i.step)))
            }
            ...
            function l(e) {
                ...
                switch (r.length) {
                    case 2:
                        return {
                            start: r[0], end: r[1], step: 1
                        };
                    case 3:
                        return {
                            start: r[0], end: r[2], step: r[1]
                        };
                    default:
                        return null
                }
        ...
        e.exports = [r(336), r(363), r(394), r(410), r(419), r(424), r(427), r(433), r(445), r(454), r(458), r(465), r(467), r(493), r(495)]
    }, function(e, t, r) {
        ...
        function n(e, t, n, i) {
            var a = n(r(52)),
                ...
                x = function(e) {
                    ...
                    for (r = 0; a > r; r++)
                        for (t = 0; i > t; t++) 0 === r && (a > t && (x[t] = []), v[t] = []), r > t ? (a > t && (x[t][r] = d[t][r]), i > r && (v[t][r] = 0)) : t !== r ? (a > t && (x[t][r] = 0), i > r && (v[t][r] = d[t][r])) : (a > t && (x[t][r] = d[t][r]), i > r && (v[t][r] = 1));
                    var S = new g({
                            data: v,
                            size: y
                        }),
            ...
            var o = n(r(339)),
                ...
                u = i("slu", {
                    "SparseMatrix, number, number": function(e, t, r) {
                        if (!a(t) || 0 > t || t > 3) throw new Error("Symbolic Ordering and Analysis order must be an integer number in the interval [0, 3]");
        ...
        function n(e, t, n) {
            var i = n(r(340)),
                ...
                f = function(e, t) {
                    ...
                    for (s = o - 1; s >= 0; s--) h[s] = -1, u = m[s], -1 != u && (0 === d[x + u]++ && (d[y + u] = s), d[g + s] = d[v + u], d[v + u] = s);
        ...
        function n(e, t, n) {
            var i = n(r(341)),
                ...
                f = function(e, t) {
                    ...
                    var f = l(e, t, n, s, c);
                    o(f, d, null);
                    for (var g, v, y, x, b, w, N, E, M, A, O, _, T, C, S, z, B = f._index, k = f._ptr, I = k[s], P = [], R = [], U = 0, q = s + 1, L = 2 * (s + 1), j = 3 * (s + 1), F = 4 * (s + 1), D = 5 * (s + 1), $ = 6 * (s + 1), G = 7 * (s + 1), H = P, Z = p(s, k, R, U, j, H, L, G, q, $, F, D), V = h(s, k, R, D, F, $, c, q, j, H, L), Y = 0; s > V;) {
                        for (y = -1; s > Y && -1 == (y = R[j + Y]); Y++); - 1 != R[L + y] && (H[R[L + y]] = -1), R[j + Y] = R[L + y];
                        var W = R[F + y],
                            X = R[q + y];
                        V += X;
                        var J = 0;
                        ...
                        var Q = k[y],
                            ...
                            ee = K;
                        for (x = 1; W + 1 >= x; x++) {
                            for (x > W ? (w = y, N = Q, E = R[U + y] - W) : (w = B[Q++], N = k[w], E = R[U + w]), b = 1; E >= b; b++) g = B[N++], (M = R[q + g]) <= 0 || (J += M, R[q + g] = -M, B[ee++] = g, -1 != R[L + g] && (H[R[L + g]] = H[g]), -1 != H[g] ? R[L + H[g]] = R[L + g] : R[j + R[D + g]] = R[L + g]);
                            w != y && (k[w] = i(y), R[$ + w] = 0)
                        }
                        for (0 !== W && (I = ee), R[D + y] = J, k[y] = K, R[U + y] = ee - K, R[F + y] = -2, Z = m(Z, u, R, $, s), A = K; ee > A; A++)
                            if (g = B[A], !((O = R[F + g]) <= 0)) {
                                M = -R[q + g];
                                var te = Z - M;
                                for (Q = k[g], _ = k[g] + O - 1; _ >= Q; Q++) w = B[Q], R[$ + w] >= Z ? R[$ + w] -= M : 0 !== R[$ + w] && (R[$ + w] = R[D + w] + te)
                            } for (A = K; ee > A; A++) {
                        ...
                        for (R[D + y] = J, u = Math.max(u, J), Z = m(Z + u, u, R, $, s), A = K; ee > A; A++)
                            if (g = B[A], !(R[q + g] >= 0))
                                for (S = H[g], g = R[G + S], R[G + S] = -1; - 1 != g && -1 != R[L + g]; g = R[L + g], Z++) {
                                    for (E = R[U + g], O = R[F + g], Q = k[g] + 1; Q <= k[g] + E - 1; Q++) R[$ + B[Q]] = Z;
                                    var ae = g;
                                    for (v = R[L + g]; - 1 != v;) {
                                        var se = R[U + v] === E && R[F + v] === O;
                                        for (Q = k[v] + 1; se && Q <= k[v] + E - 1; Q++) R[$ + B[Q]] != Z && (se = 0);
                                        se ? (k[v] = i(g), R[q + g] += R[q + v], R[q + v] = 0, R[F + v] = -1, v = R[L + v], R[L + ae] = v) : (ae = v, v = R[L + v])
                                    }
                                }
                        for (Q = K, A = K; ee > A; A++) g = B[A], (M = -R[q + g]) <= 0 || (R[q + g] = M, z = R[D + g] + J - M, z = Math.min(z, s - V - M), -1 != R[j + z] && (H[R[j + z]] = g), R[L + g] = R[j + z], H[g] = -1, R[j + z] = g, Y = Math.min(Y, z), R[D + g] = z, B[Q++] = g);
                        R[q + y] = X, 0 === (R[U + y] = Q - K) && (k[y] = -1, R[$ + y] = 0), 0 !== W && (I = Q)
                    }
                    for (g = 0; s > g; g++) k[g] = i(k[g]);
                    for (v = 0; s >= v; v++) R[j + v] = -1;
                    for (v = s; v >= 0; v--) R[q + v] > 0 || (R[L + v] = R[j + k[v]], R[j + k[v]] = v);
                    for (w = s; w >= 0; w--) R[q + w] <= 0 || -1 != k[w] && (R[L + w] = R[j + k[w]], R[j + k[w]] = w);
                ...
                p = function(e, t, r, n, i, o, a, s, u, c, f, l) {
                    ...
                    r[n + e] = 0;
                    for (var h = 0; e >= h; h++) r[i + h] = -1, o[h] = -1, r[a + h] = -1, r[s + h] = -1, r[u + h] = 1, r[c + h] = 1, r[f + h] = 0, r[l + h] = r[n + h];
                    var d = m(0, 0, r, c, e);
        ...
        function r() {
            var e = function(e, t, r) {
                for (var n = e._values, i = e._index, o = e._ptr, a = e._size, s = a[1], u = 0, c = 0; s > c; c++) {
                    var f = o[c];
                    for (o[c] = u; f < o[c + 1]; f++) t(i[f], c, n ? n[f] : 1, r) && (i[u] = i[f], n && (n[u] = n[f]), u++)
                }
        ...
        function r() {
            var e = function(e, t, r, n, i, o, a) {
                ...
                for (r[a] = e; s >= 0;) {
                    var u = r[a + s],
                        c = r[n + u]; - 1 == c ? (s--, o[t++] = u) : (r[n + u] = r[i + c], ++s, r[a + s] = c)
                }
                return t
            };
            return e
        ...
        function n(e, t, n, a) {
            var s = r(32),
                    ...
                    Matrix: function(e) {
                        ...
                        switch (r.length) {
                            ...
                            case 2:
                                var n = r[0],
                                    i = r[1];
                                if (0 === i) throw new RangeError("Cannot transpose a 2D matrix with no columns (size: " + o(r) + ")");
                                switch (e.storage()) {
                                    case "dense":
                                        t = p(e, n, i);
                                        break;
                ...
                h = function(e, t, r) {
                    for (var n = e._values, o = e._index, a = e._ptr, s = n ? [] : void 0, u = [], c = [], l = [], p = 0; t > p; p++) l[p] = 0;
                    var h, m, d;
        ...
        function r(e) {
            var t = e.SparseMatrix,
                r = function(e, r, n, i) {
                    for (var o = e._values, a = e._index, s = e._ptr, u = e._size, c = e._datatype, f = u[0], l = u[1], p = i && e._values ? [] : null, h = [], m = [], d = 0, g = 0; l > g; g++) {
                        m[g] = d;
        ...
        function n(e, t, n) {
            var i = n(r(343)),
                o = function(e, t) {
                    ...
                    for (r = t - 1; r >= 0; r--) - 1 != e[r] && (a[u + r] = a[s + e[r]], a[s + e[r]] = r);
            ...
            var i = n(r(86)),
                ...
                l = function(e, t, r) {
                    ...
                    for (var T = 0; p > T; T++) {
                        ...
                        var I = O[z];
                        for (N[m] = T, w[m++] = I, A[z] = T, y[h] = z, v[h++] = 1, g = S; p > g; g++) d = _[g], A[d] < 0 && (y[h] = d, v[h++] = o(O[d], I)), O[d] = 0
                    }
                ...
                u = function(e, t, r, n, u, c, f) {
                    ...
                    for (var M = E; x > M; M++) {
                        var A = n[M],
                            O = c ? c[A] : A;
                        if (!(0 > O))
                            for (p = v[O], h = v[O + 1], u[A] = i(u[A], d[f ? p : h - 1]), l = f ? p + 1 : p, m = f ? h : h - 1; m > l; l++) {
                                var _ = g[l];
                                u[_] = a(u[_], o(d[l], u[A]))
                            }
                    }
        ...
        function n(e, t, n, i) {
            var o = n(r(52)),
                ...
                h = function(e, t) {
                    t = f(e, t, !0);
                    for (var r = t._data, n = e._size[0], i = e._size[1], o = [], p = e._data, h = 0; i > h; h++) {
                        var m, d = r[h][0] || 0;
                        if (c(d, 0)) m = 0;
                        else {
                            var g = p[h][h];
                ...
                m = function(e, t) {
                    t = f(e, t, !0);
                    for (var r, n, i = t._data, o = e._size[0], p = e._size[1], h = e._values, m = e._index, d = e._ptr, g = [], v = 0; p > v; v++) {
                        var y = i[v][0] || 0;
                        if (c(y, 0)) g[v] = [0];
                        else {
                            var x = 0,
        ...
        function n(e, t, n, i) {
            var o = n(r(52)),
                ...
                h = function(e, t) {
                    t = f(e, t, !0);
                    for (var r = t._data, n = e._size[0], i = e._size[1], o = [], p = e._data, h = i - 1; h >= 0; h--) {
                        var m, d = r[h][0] || 0;
                        if (c(d, 0)) m = 0;
                        else {
                            var g = p[h][h];
                ...
                m = function(e, t) {
                    t = f(e, t, !0);
                    for (var r, n, i = t._data, o = e._size[0], p = e._size[1], h = e._values, m = e._index, d = e._ptr, g = [], v = p - 1; v >= 0; v--) {
                        var y = i[v][0] || 0;
                        if (c(y, 0)) g[v] = [0];
                        else {
                            var x = 0,
        ...
        e.exports = [r(86), r(51), r(53), r(364), r(366), r(367), r(326), r(368), r(370), r(372), r(373), r(87), r(374), r(375), r(376), r(379), r(382), r(383), r(384), r(84), r(385), r(387), r(82), r(388), r(390), r(377), r(391), r(77), r(78), r(392), r(393)]
    }, function(e, t, r) {
        "use strict";
            ...
            var a = n(r(48)),
                ...
                u = function(e, t, r, n) {
                    ...
                    var g, v = c[0],
                        ...
                        b = 0,
                        w = r;
                    "string" == typeof f && f === d && (g = f, x = o.find(a, [g, g]), b = o.convert(0, g), w = o.find(r, [g, g]));
            ...
            var a = n(r(48)),
                ...
                u = function(e, t, r) {
                    ...
                    for (M = 0; x > M; M++) {
                        ...
                        var I = M + 1;
                        if (B)
                            for (O = m[M], _ = m[M + 1], A = O; _ > A; A++) E = h[A], k[E] = I, B[E] = p[A];
            ...
            var s = n(r(48)),
                ...
                c = function(e, t, r) {
                    ...
                    var m, d = c[0],
                        ...
                        y = 0,
                        x = r;
                    "string" == typeof f && f === h && (m = f, v = a.find(s, [m, m]), y = a.convert(0, m), x = a.find(r, [m, m]));
        ...
        e.exports = function(e, t, r, n, i, o, a, s, u, c, f) {
            var l, p, h, m, d = e._values,
                ...
                y = a._index;
            if (n)
                for (p = v[t], h = v[t + 1], l = p; h > l; l++) m = g[l], r[m] !== o ? (r[m] = o, y.push(m), c ? (n[m] = u ? s(d[l], f) : s(f, d[l]), i[m] = o) : n[m] = d[l]) : (n[m] = u ? s(d[l], n[m]) : s(n[m], d[l]), i[m] = o);
            else
                for (p = v[t], h = v[t + 1], l = p; h > l; l++) m = g[l], r[m] !== o ? (r[m] = o, y.push(m)) : i[m] = o
        }
    }, function(e, t, r) {
        "use strict";
        ...
        function o(e, t) {
            ...
            for (var r = e.arg(), n = e.abs(), i = [], o = Math.pow(n, 1 / t), a = 0; t > a; a++) i.push({
                r: o,
                phi: (r + 2 * Math.PI * a) / t
            });
            return i
        ...
        function n(e, t, n, o) {
            function a(e, r) {
                ...
                for (; r;) o = Math.floor(e / r), a = e % r, n = s, s = c - o * s, c = n, n = f, f = l - o * f, l = n, e = r, r = a;
                var p;
            ...
            function s(r, n) {
                ...
                for (; !n.isZero();) o = r.div(n).floor(), a = r.mod(n), i = f, f = l.minus(o.times(f)), l = i, i = p, p = h.minus(o.times(p)), h = i, r = n, n = a;
                var m;
        ...
        e.exports = function(e, t) {
            ...
            var o = new r(-1);
            return e.eq(o) ? i(t) : t.eq(o) ? i(e) : e.isFinite() && t.isFinite() ? n(e, t, function(e, t) {
                return e ^ t
            }) : e.isFinite() || t.isFinite() ? new r(e.isNegative() == t.isNegative() ? 1 / 0 : -(1 / 0)) : o
        }
    }, function(e, t, r) {
        "use strict";
            ...
            var a = n(r(48)),
                ...
                u = function(e, t, r) {
                    ...
                    for (var E, M, A, O, _ = [], T = [], C = [], S = new s({
                        ...
                        C[k] = T.length;
                        var I = k + 1;
                        for (M = c[k], A = c[k + 1], E = M; A > E; E++) O = u[E], B[O] = I, z[O] = n[E], T.push(O);
                        for (M = m[k], A = m[k + 1], E = M; A > E; E++) O = h[E], B[O] === I && (z[O] = N(z[O], p[E]));
        ...
        function n(e, t, n, u) {
            function c(r) {
                ...
                for (var n = t.precision + (0 | Math.log(r.toNumber())), i = e.BigNumber.clone({
                        precision: n
                    }), o = new i(r), a = r.toNumber() - 1; a > 1;) o = o.times(a), a--;
                ...
                p = u("gamma", {
                    ...
                    Complex: function(t) {
                        ...
                        for (var i = 1; i < s.length; ++i) {
                            var o = t.re + i,
                                u = o * o + t.im * t.im;
                            0 != u ? (n.re += s[i] * o / u, n.im += -(s[i] * t.im) / u) : n.re = s[i] < 0 ? -(1 / 0) : 1 / 0
                        }
        ...
        function n(e, t, r, n) {
            var a = n("combinations", {
                "number, number": function(e, t) {
                    var r, n, i;
                    if (!o(e) || 0 > e) throw new TypeError("Positive integer value expected in function combinations");
                    if (!o(t) || 0 > t) throw new TypeError("Positive integer value expected in function combinations");
                    if (t > e) throw new TypeError("k must be less than or equal to n");
                    for (r = Math.max(t, e - t), n = 1, i = 1; e - r >= i; i++) n = n * (r + i) / i;
                    return n
                },
                "BigNumber, BigNumber": function(t, r) {
                    var n, o, a, s, u = new e.BigNumber(1);
                    ...
                    for (n = t.minus(r), r.lt(n) && (n = r), o = u, a = u, s = t.minus(n); a.lte(s); a = a.plus(1)) o = o.times(n.plus(a)).dividedBy(a);
                    return o
                }
            });
            return a.toTex = {
        ...
        e.exports = [r(310), r(434), r(328), r(435), r(436), r(83), r(312), r(437), r(314), r(327), r(317), r(438), r(439), r(332), r(441), r(442), r(443), r(444), r(285), r(386), r(344), r(389)]
    }, function(e, t, r) {
        "use strict";
        ...
        function n(e, t, n, a) {
            ...
            function c(e, t, r, n, i, o) {
                ...
                for (var s = Math.min(n[0] - i, n[1] - o), u = [], c = 0; s > c; c++) u[c] = e[c + i][c + o];
                return null !== r ? f(u) : u
            }
            var f = n(r(52)),
                l = a("diag", {
        ...
        function n(e, t, n, f) {
            function l(e, t, r) {
                ...
                var n = t[0];
                if ("number" != typeof n || !a(n)) throw new TypeError("Invalid size, must contain positive integers (size: " + s(t) + ")");
        ...
        function n(e, t, n, a) {
            var s = n(r(413)),
                u = a("permutations", {
                    ...
                    "number, number": function(e, t) {
                        var r, n;
                        if (!o(e) || 0 > e) throw new TypeError("Positive integer value expected in function permutations");
                    ...
                    "BigNumber, BigNumber": function(t, r) {
                        ...
                        for (n = new e.BigNumber(1), o = t.minus(r).plus(1); o.lte(t); o = o.plus(1)) n = n.times(o);
                        return n
                    }
                });
            return u.toTex = void 0, u
                ...
                return function(e) {
                    var t = {
                            random: function(e, t, n) {
                                ...
                                if (1 === arguments.length ? o(e) ? s = e : f = e : 2 === arguments.length ? o(e) ? (s = e, f = t) : (c = e, f = t) : (s = e, c = t, f = n), void 0 === f && (f = 1), void 0 === c && (c = 0), void 0 !== s) {
                            ...
                            randomInt: function(e, t, r) {
                                ...
                                if (1 === arguments.length ? o(e) ? s = e : f = e : 2 === arguments.length ? o(e) ? (s = e, f = t) : (c = e, f = t) : (s = e, c = t, f = r), void 0 === c && (c = 0), void 0 !== s) {
                        ...
                        a = function(e, t, r, n) {
                            ...
                            if (e = e.slice(0), e.length > 1)
                                ...
                                for (o = 0, i = e.shift(); i > o; o++) s.push(n(t, r));
                            return s
                        };
                    return t
                }(r)
        ...
        function n(e, t, n, a) {
            function s(e) {
                ...
                if (t % 2 == 0) {
                    for (var r = t / 2 - 1, n = l(e, r + 1), o = e[r], a = 0; r > a; ++a) f(e[a], o) > 0 && (o = e[a]);
                    return m(o, n)
                }
                var s = l(e, (t - 1) / 2);
                return h(s)
        ...
        function n(e, t, r, n) {
            function o(e) {
                ...
                var r = {},
                    n = [],
                    o = 0;
                for (var a in e) e[a] in r || (r[e[a]] = 0), r[e[a]]++, r[e[a]] == o ? n.push(e[a]) : r[e[a]] > o && (o = r[e[a]], n = [e[a]]);
                return n
            }
            var a = n("mode", {
                "Array | Matrix": o,
        ...
        e.exports = [r(468), r(469), r(470), r(471), r(472), r(473), r(474), r(475), r(476), r(477), r(478), r(479), r(480), r(481), r(482), r(483), r(484), r(485), r(486), r(487), r(488), r(489), r(490), r(491), r(492)]
    }, function(e, t, r) {
        "use strict";
        ...
        function n(e, t, r, n) {
            var a = n("acosh", {
                number: function(r) {
                    return r >= 1 || t.predictable ? o(r) : -1 >= r ? new e.Complex(Math.log(Math.sqrt(r * r - 1) - r), Math.PI) : new e.Complex(r, 0).acosh()
                },
                Complex: function(e) {
                    return e.acosh()
                },
        ...
        function n(e, t, n, o) {
            var a = (o.find(n(r(469)), ["Complex"]), o("asech", {
                number: function(r) {
